...
public class PlayerSeasonFragment extends android.support.v4.app.Fragment {
    private PlayerCrawler player;
    public TableLayout tl;

    public static PlayerSeasonFragment newInstance(PlayerCrawler player) {
        PlayerSeasonFragment fragment = new PlayerSeasonFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_player_season, container, false);
        tl = (TableLayout) view.findViewById(R.id.seasonTable);
