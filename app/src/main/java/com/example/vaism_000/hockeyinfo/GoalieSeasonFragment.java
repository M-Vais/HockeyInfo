...
public class GoalieSeasonFragment extends android.support.v4.app.Fragment {
    public PlayerCrawler player;

    public static GoalieSeasonFragment newInstance(PlayerCrawler player) {
        GoalieSeasonFragment fragment = new GoalieSeasonFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_goalie_season, container, false);

        TableLayout table = (TableLayout) view.findViewById(R.id.seasonTable);
        TableRow tableRows[] = new TableRow[player.seasonStats.size() + 1];
